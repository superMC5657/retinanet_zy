...
class CrissCrossAttention(nn.Module, ABC):
    ...
    def __init__(self, in_planes, ):
        ...
        self.query_conv = nn.Conv2d(in_channels=in_planes, out_channels=in_planes // 8, kernel_size=1)
        self.key_conv = nn.Conv2d(in_channels=in_planes, out_channels=in_planes // 8, kernel_size=1)
